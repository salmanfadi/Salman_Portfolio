...
const AppHead: React.FC<Props> = ({
  ...
  let author = "Salman Fadi";
  let description =
    "Articles about programming, coding, technologies, football, my personal projects and my experiences.";
  let siteName = "Salman Fadi's Blog";
  let type = "article";
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/salman-blog-og.png`;
  let appOgImageAlt = "Salman Fadi's Blog";
