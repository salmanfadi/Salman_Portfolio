...
const BlogImageCard: React.FC<Props> = ({
  ...
  return (
    <div
      ref={sectionRef}
      className={`sm:min-w-[17rem] transition translate-y-2 hover:-translate-y-0 max-w-lg bg-gray-100 dark:bg-carddark p-4 rounded shadow-md hover:shadow-xl w-full ${
        fullWH ? "w-full" : "w-lg my-2"
      } ${className}`}
    >
