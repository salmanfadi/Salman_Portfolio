...
import salman from "../public/salman_illustration.webp";
  ...
  return (
    ...
    >
      ...
      <div className="image-animation z-10 select-none mt-0 xs:mt-6 sm:mt-14 lg:mt-0 px-0 mx-auto lg:p-0 lg:basis-1/3">
        <div className="relative w-55 md:w-60 h-60 flex items-center mx-auto">
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          ...
          <p>
            With my expertise in React and NextJS on the frontend, and
            Flask, NodeJS, and Express on the backend, I bring a unique
