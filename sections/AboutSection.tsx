...
import salmanPhoto from "../public/salman.webp";
      ...
      <section id="whoami" className="section">
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-5 grid-cols-5">
            <div className="col-start-1 col-end-3 row-start-1 row-end-4 lg:row-end-7 lg:col-start-1 lg:col-end-3 flex justify-center items-center py-2 mb-4 lg:mb-[1%] w-[70%] h-[70%]">
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              ...
              I specialize in building robust, user-centric web applications '
              from the ground up. With a strong foundation in both frontend and backend technologies, 
              I bring ideas to life through clean code, intuitive UI, 
              and scalable backend systems. My academic background complements my practical experience, 
              giving me a well-rounded approach to problem-solving and development.
            </p>

            <div
              className="col-start-3 col-end-6 row-start-1 row-end-6 lg:row-start-2 lg:row-end-7 md:ml-8 mt-10"
              ref={eduRef}
            >
...
const educationInfo = [
  {
    id: 1,
    title: "B.Tech CSE",
    subTitle: "Lovely Professional University | 2022 ~ 2026",
    list: [
      "Studying computer science, software development, Data Science",
      "Experiencing life with vast diversity of LPU",
    ],
  },
  {
    id: 2,
    title: "Higher Secondary",
    subTitle: "Dayapuram Residential School | 2021",
    list: ["Passed with 82 percentile."],
  },
];
