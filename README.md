# Salman Portfolio & Blog

![salman-portfolio-and-blog](https://user-images.githubusercontent.com/53733092/169645862-d1dda9cb-482f-4428-a63c-8eaf6910ab35.png)
![ts](https://badgen.net/badge/Built%20With/TypeScript/blue) ![vercel](https://img.shields.io/github/deployments/salman/my-portfolio/production?label=vercel&logo=vercel&logoColor=white)
...
<p align="center">
  <a href="https://pagespeed.web.dev/report?url=https%3A%2F%2Fsalman.dev%2F&form_factor=desktop">
    <img width="710" alt="Salman Portfolio Website Lighthouse Score" src="public/lighthouse-result.svg">
  <a>
</p>
...
```bash
git clone https://github.com/salman/salman.dev.git
```
